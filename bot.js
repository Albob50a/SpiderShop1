...
client.on("ready", async  => {
setInterval(function(){
client.channels.find('id', '579109625530679296').setName("S");
client.channels.find('id', '579109625530679296').setName("Sp");
client.channels.find('id', '579109625530679296').setName("Spi");
client.channels.find('id', '579109625530679296').setName("Spid");
client.channels.find('id', '579109625530679296').setName("Spide");
client.channels.find('id', '579109625530679296').setName("Spider");
  }, 2500);
});
